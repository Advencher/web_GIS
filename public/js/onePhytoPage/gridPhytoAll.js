//$(document).ready(function () {
    ...
    gridFT = $('#grid').grid({
        ...
        columns: [
            ...
            { field: 'Station', title:'Станция', sortable: true, width: 200},
    ...
    $('#btnAdd').click(function() {
        addRowPhytoGlobal('#grid', maxIdURLFT, id_sample, station, id_station, date, time, utc, insertURLFT, gridFT, cancelFT, rowsOnPageFT, changedRowsFT, variableFT);
    });
