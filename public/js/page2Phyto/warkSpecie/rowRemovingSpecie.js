function rowRemowingSpecie(record, deleteURL, cancel, rowsOnPage, changedRows, variable){
    if (confirm('Вы уверены?')) {
        ...
        $.ajax({ url: deleteURL, data: { 'dataRow': dataForDeleteSpecie(record) }, method: 'POST' })
            .done(function () {
