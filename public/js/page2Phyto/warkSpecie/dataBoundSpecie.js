function dataBoundSpecie(rowsOnPage, variable, grid, records){

    if (variable.pageChanged === true) {
        deleteCBDataDataBound(rowsOnPage, '#gridFT1', 1); //Если из edit не вышел, но обновил страницу, изменил число строк на странице, перешел на другую страницу
        rowsOnPage.length = 0;
    }
