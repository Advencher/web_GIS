...
gj.grid.plugins.inlineEditing.config = {
    ...
    bootstrap4: {
        inlineEditing: {
            managementColumnConfig: { width: 150, role: 'managementColumn', align: 'center', renderer: gj.grid.plugins.inlineEditing.renderers.editManager, cssClass: 'gj-grid-management-column' }
        }
    }
};
...
gj.grid.plugins.inlineEditing.public = {
    ...
    cancel: function (id) {
        ...
        gj.grid.plugins.inlineEditing.events.rowCancelChanged(this, id, record);
...
gj.grid.plugins.inlineEditing.events = {
    ...
    rowCancelChanged: function($grid, id, record) {
        $grid.triggerHandler('rowCancelChanged', [id, record]);
    }
};
...
gj.grid.messages['en-us'] = {
    ...
    Refresh: 'Обновить',
    Of: 'из',
    DisplayingRecords: 'Показаны записи',
